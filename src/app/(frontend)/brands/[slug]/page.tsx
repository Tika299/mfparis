...
export default async function BrandProductsPage({
  ...
  searchParams: Promise<{ min?: string; max?: string; sort?: string; category?: string; brand?: string }>
}) {
  ...
  // category là lọc cộng thêm trong brand
          ...
          <main className="min-w-0 flex-1">
            {productsRes.docs.length > 0 ? (
              ...
              <div className="lc-card rounded-2xl py-16 text-center md:py-24">
                <p className="text-lg font-bold md:text-xl">Chưa có sản phẩm nào trong thương hiệu này.</p>
              </div>
            )}
          </main>
        </div>
