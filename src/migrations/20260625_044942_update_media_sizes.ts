...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
    ...
    UPDATE "media"
    SET
      "sizes_hero_desktop_url" = "sizes_large_url",
      "sizes_hero_desktop_width" = "sizes_large_width",
      "sizes_hero_desktop_height" = "sizes_large_height",
      "sizes_hero_desktop_mime_type" = "sizes_large_mime_type",
      "sizes_hero_desktop_filesize" = "sizes_large_filesize",
      "sizes_hero_desktop_filename" = "sizes_large_filename"
    WHERE "sizes_large_url" IS NOT NULL;
