      ...
      fields: [
        {
          name: 'enabled',
          type: 'checkbox',
          label: 'Bật tự động chèn internal link toàn site',
          defaultValue: false,
        },
        {
          name: 'previewOnly',
          type: 'checkbox',
          label: 'Chỉ preview, chưa áp dụng frontend',
          defaultValue: true,
        },
        {
          name: 'maxLinksPerPost',
          type: 'number',
          label: 'Tối đa link trong một bài viết',
          defaultValue: 8,
          min: 0,
          max: 30,
        },
        {
          name: 'maxLinksPerProduct',
          type: 'number',
          label: 'Tối đa link trong mô tả sản phẩm',
          defaultValue: 5,
          min: 0,
          max: 20,
        },
        {
          name: 'maxLinksPerLanding',
          type: 'number',
          label: 'Tối đa link trong trang danh mục/thương hiệu',
          defaultValue: 8,
          min: 0,
          max: 30,
        },
        {
          name: 'maxLinksPerParagraph',
          type: 'number',
          label: 'Tối đa link trong một đoạn',
          defaultValue: 1,
          min: 0,
          max: 5,
        },
        {
          name: 'maxSameTargetUrl',
          type: 'number',
          label: 'Tối đa link trùng URL đích',
          defaultValue: 2,
          min: 1,
          max: 10,
        },
        {
          name: 'maxSameAnchor',
          type: 'number',
          label: 'Tối đa anchor giống nhau',
          defaultValue: 1,
          min: 1,
          max: 10,
        },
